  ...
  return (
    ...
    <div className=" flex items-center  p-2 lg:p-0 justify-center">
      ...
      <div className="your name   flex flex-col lg:space-y-2 text-[#c2bfbf]    ">
        <span className='lg:text-[20px] text-green-600 font-bold'>Your Name </span>
        <div className=" border-b-[1px]  py-1 lg:py-2 border-[#171717] flex justify-between items-center text-[#c0bbbb]   lg:text-[23px]">
        <div className=" first-letter:uppercase lg:text-[18px] text-[16px] ">
         {name}
        </div>
        ...
        <span className='lg:text-[20px] text-[16px] border-b-[1px] py-2 border-[#171717] '>
      ...
      <div className=" text-[#cac8c8]  border-b-[1px] border-[#171717] py-2 ">
        <span className='lg:text-[20px] text-green-600 font-bold '>About</span>

        <div className=" justify-between flex items-center">
        <span className='lg:text-[18px] text-[15px]'> Hey,I am using QuickChat. </span>
        <span className="material-symbols-outlined text-[18px]">
            edit
          </span>
      ...
      <div className="border-b-[1px] border-[#171717] py-2 text-[#cac8c8]  ">
        <span className='lg:text-[20px]   text-green-600 font-bold '>Your email address</span>

        <div className=" justify-between flex">
        <span className='lg:text-[18px] text-[15px]'>{email}</span>
        </div>
      </div>
        <span onClick={handleLogout} className='lg:text-[20px] py-2 text-[16px] flex items-center  cursor-pointer text-red-600 space-x-2 '>
          <span>logout</span>
